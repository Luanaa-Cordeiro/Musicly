...
<div class="table-wrapper">
    ...
    <tr>
        ...
        <td>{{$genero->nome}}</td>
        <td id='botões'>
            <button id="editar"><a href="{{ route('generos.edit', ['genero' => $genero->id]) }}">Editar</a></button>
            <button id="deletar"><a href="{{route('generos.show',['genero' => $genero->id])}}">Mostrar</a></button>
        </td>
    </tr>
    @endforeach
</tbody>
...
@csrf
  <div data-mdb-input-init class="form-outline mb-4">
    <label class="form-label" for="nome_genero" style="color:white;">Nome do Gênero<span class="asterisco">*</span></label>
