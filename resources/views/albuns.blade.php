...
<div class='adicionar'>
    <h2>Álbuns</h2>
    <a href="{{route('albuns.create')}}"><button>Adicionar</button></a>
</div>
...
<div class="table-wrapper">
    ...
    <tr>
        ...
        <td id='botões'>
            <button id="editar"><a href="{{ route('albuns.edit', ['album' => $album->id]) }}">Editar</a></button>
            <button id="deletar"><a href="{{route('albuns.show',['album' => $album->id])}}">Mostrar</a></button>
        </td>
    </tr>
    @endforeach
</tbody>
